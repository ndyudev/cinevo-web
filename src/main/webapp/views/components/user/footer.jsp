    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-12 col-lg-4">
                 ...
                 <ul class="list-unstyled text-secondary small">
                    <li class="mb-3"><i class="fa-solid fa-location-dot me-2 text-danger"></i> 227 Bến Thành, Quận 1, Hồ Chí Minh.</li>
                    <li class="mb-3"><i class="fa-solid fa-envelope me-2 text-danger"></i> contact.work@cinevo.com</li>
                    <li class="mb-3"><i class="fa-solid fa-phone me-2 text-danger"></i> (+84) 787 544 232</li>
                </ul>
        ...
        <div class="row mt-5 pt-3 border-top border-secondary border-opacity-25">
            <div class="col-md-6 text-center text-md-start">
                <p class="small text-secondary mb-0">&copy; 2025 <strong>Cinevo</strong>. All Rights Reserved. Designed by <strong>DXA Studio</strong>.</p>
            </div>
